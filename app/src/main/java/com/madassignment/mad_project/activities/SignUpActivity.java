...
import com.madassignment.mad_project.databinding.ActivitySignInBinding;
import com.madassignment.mad_project.databinding.ActivitySignUpBinding;
...
public class SignUpActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ViewCompat.setOnApplyWindowInsetsListener(findViewById(R.id.mainUp), (v, insets) -> {
